...
func (in *NodeHealthCheckStatus) DeepCopyInto(out *NodeHealthCheckStatus) {
	*out = *in
	...
	if in.StormRegainingHealthyConstraintTime != nil {
		in, out := &in.StormRegainingHealthyConstraintTime, &out.StormRegainingHealthyConstraintTime
		*out = (*in).DeepCopy()
	}
...
func (in *UnhealthyNode) DeepCopyInto(out *UnhealthyNode) {
	*out = *in
	...
	if in.ConditionsHealthyTimestamp != nil {
		in, out := &in.ConditionsHealthyTimestamp, &out.ConditionsHealthyTimestamp
		*out = (*in).DeepCopy()
	}
	if in.HealthyDelayed != nil {
		in, out := &in.HealthyDelayed, &out.HealthyDelayed
		*out = new(bool)
		**out = **in
	}
}
